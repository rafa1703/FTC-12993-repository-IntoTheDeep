        ...
        switch (state)
        {
            ...
            case INTAKE_EXTENDO:
                ...
                if (delay(170))
                {
                    ...
                    if (delay(200) && colorValue > 800 || (gamepad1.right_trigger > 0.2 || gamepad2.right_trigger > 0.2) ||
            ...
            case MANUAL_ENCODER_RESET:
                ...
                if (gamepad2.x) intakeSubsystem.intakeChute(IntakeSubsystem.IntakeChuteServoState.DROP);
