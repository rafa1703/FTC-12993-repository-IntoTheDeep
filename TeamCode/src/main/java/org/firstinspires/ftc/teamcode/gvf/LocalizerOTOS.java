...
public class LocalizerOTOS
{
    public static boolean ENABLED = true;
    private Pose pose;
    private SparkFunOTOS otos;
    public LocalizerOTOS(GeneralHardware hardware)
    {
        this(hardware, new Pose());
    }

    public LocalizerOTOS(GeneralHardware hardware, Pose pose)
    {
        otos = hardware.hardwareMap.get(SparkFunOTOS.class, "otos");
        this.pose = pose;
