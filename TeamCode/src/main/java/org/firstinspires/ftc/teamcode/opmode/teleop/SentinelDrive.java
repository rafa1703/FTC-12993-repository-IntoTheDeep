...
//                    liftHeightLogic(gamepad2.x, gamepad2.a);
                ...
                {
//                    if (!internalDelay(400)) {
//                        outtakeSubsystem.armSetPos(0.7);
//                        outtakeSubsystem.wristSetPos(0.3);
//                    }
//                    if (internalDelay(100) && ! internalDelay(500)) {
//                        outtakeSubsystem.liftMotorRawControl(-1);
//
//                    }
                    if (internalDelay(40)) outtakeSubsystem.clawState(OuttakeSubsystem.OuttakeClawServoState.INTAKE);
...
//                outtakeSubsystem.turretSpinTo(OuttakeSubsystem.OuttakeTurretState.TRANSFER_BACK);
                ...
                break;
            case HANG_LEVEL3:
                if ((outtakeSubsystem.getPositionIn() < 0 && delay(3000)) || delay(7000))
                {
                    state = OuttakeState.HANG_END;
            ...
            case HANG_END:
                ...
                {
                    intakeSubsystem.intakeClip(IntakeSubsystem.IntakeClipServoState.OPEN);
                    intakeSubsystem.intakeSlideInternalPID(7.5);
                }
                break;
            case RETURN:
...
//    }
    ...
    {
        return intakeSubsystem.sampleInIntakeWithColourCheck(goToHPExtendoDeposit); // we want to go to hp when cycling colour lmao
    }
