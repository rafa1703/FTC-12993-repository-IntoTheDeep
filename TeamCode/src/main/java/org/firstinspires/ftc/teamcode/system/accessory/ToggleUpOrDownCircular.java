...
public class ToggleUpOrDownCircular
{
    ...
    public ToggleUpOrDownCircular(double upIncrement, double downIncrement, int targetPosition, int maxOffset){
    ...
    public void downToggle (boolean Btn, int incrementMultiplier){
        if (Btn) {
            if (!ToggleDown) {
                ...
                else OffsetTargetPosition = (int) (maxOffset - (DownIncrement * incrementMultiplier));
            }
        }
        else {
            ToggleDown = false;
